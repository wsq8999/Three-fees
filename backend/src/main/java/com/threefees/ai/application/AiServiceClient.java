...
public class AiServiceClient {
  ...
  static String reportStyleGuide(String normalizedIntent) {
    ...
    return """
        你正在生成“电费稽核说明”工作稿，不是在聊天。updatedSections 必须按真实电费稽核说明短格式输出，文字精简、正式、落地。
        ...
        5. updatedSections 允许使用简单 HTML 排版：标题用 h1，章节用 h2，正文用 p，真正的业务原因和关键核查结论用 strong，图片仍保留原 inline-image-row/figure/img 标签。
        ...
        C. 如果机房图在前，就先写“机房全景图：”或“设备机柜现场图：”并紧跟该图；如果设备图在前，就先写“设备情况：...”并紧跟该图，设备情况必须尽量写清运营商、制式、厂家/型号、设备类型和数量。
        ...
        3. 设备图说明必须优先按运营商汇总可识别设备，写清制式、厂家/型号、设备类型和数量；格式示例：“设备情况：电信：4GRRU*6、5GAAU*3；移动：4G诺基亚BBU*1+RRU*3、NB BBU*1+RRU*3、5GAAU*3、700MRRU*3；联通：4G中兴BBU*1+RRU*3。”
        ...
        7. 无法确认设备归属、型号或数量时，不写无法确认的部分；整张图都无法识别具体设备时，不要添加“设备情况”说明，只保留图片原位置。
        8. 禁止虚构设备数量、运营商、型号、分摊比例、现场结论；禁止在图片说明中写“待核实”。
